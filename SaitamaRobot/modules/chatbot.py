...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows SKYLEE to talk and provides a more interactive group chat experience.
...
Reports bugs at @SkyleeHelpChat
