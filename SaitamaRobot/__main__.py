...
==========================
âœ— [Updates Channel](t.me/SkyleeUpdatesChannel)
âœ— [Support Group](t.me/SkyleeHelpChat)

Maintained by @TheFsociety2_0 
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/SkyleeHelpChat"),
                         InlineKeyboardButton(
                             text="👸 Owner",
                             url="https://t.me/TheFSociety2_0")
                     ],
                     [
                         InlineKeyboardButton(
                             text="☑️ Source code",
                             url="https://github.com/swatv3nub/clonedbot")
                     ]]))
    else:
